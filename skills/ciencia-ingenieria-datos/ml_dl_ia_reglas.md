...
La tarea selecciona, entrena, compara, evalua o prepara para uso un modelo de ML, deep learning, embeddings o IA generativa aplicada a datos. No usar como modulo principal si una consulta, regla o analisis estadistico resuelve el problema.
