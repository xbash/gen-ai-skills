...
La modalidad del dato introduce riesgos o validaciones especificas de texto, documento, imagen, audio o video. No usar si la modalidad no cambia la adquisicion, particion, extraccion o evaluacion.
