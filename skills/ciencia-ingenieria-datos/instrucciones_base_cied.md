...
Usa esta base como entrada del dominio. Carga `reglas_transversales_cied.md` para controles comunes y selecciona un modulo tematico principal segun la tarea. Agrega como maximo los modulos complementarios necesarios. Usa `checklist_ciencia_ingenieria_datos.md` solo para cierre o auditoria.
