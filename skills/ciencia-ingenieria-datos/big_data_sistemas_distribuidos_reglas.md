# Reglas especificas - Big data, paralelismo y sistemas distribuidos

## Alcance
Spark, Hadoop, Kafka, Flink, Beam, procesamiento batch, streaming, micro-batch, paralelismo, sistemas distribuidos, orquestacion, almacenamiento distribuido, escalabilidad, rendimiento y costos.

## Usar cuando

El volumen, velocidad, latencia, disponibilidad o resiliencia exige procesamiento distribuido o streaming. No usar para justificar infraestructura distribuida sin evidencia de esas restricciones.
...
## Validacion minima
Arquitectura justificada, modo de procesamiento definido, idempotencia y fallos cubiertos, costos considerados y monitoreo operacional especificado.
