...
Aplicala al cierre o durante una revisión. No la cargues como contexto obligatorio para una consulta breve.

El checklist verifica reglas de otros módulos; no agrega una política alternativa ni reemplaza el módulo temático correspondiente.
