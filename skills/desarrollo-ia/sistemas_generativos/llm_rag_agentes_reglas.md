...
La tarea diseña la arquitectura o integración de un sistema LLM, RAG, agente o herramienta. No usar como módulo principal para procesamiento lingüístico o embeddings sin orquestación de sistema.
...
Para amenazas, controles, permisos y respuesta ante incidentes, carga `../seguridad/seguridad_modelos_ia_reglas.md`. Aquí conserva solo los riesgos propios del diseño de LLM, RAG y herramientas.

## Evaluación

Define requisitos de calidad y riesgos específicos del sistema. Para suites, regresión, criterios de aceptación y comparación de versiones, carga `../ciclo_de_vida/testing_evaluacion_sistemas_ia_reglas.md`.
