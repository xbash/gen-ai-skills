...
La tarea se centra en texto, representación semántica, generación o fine-tuning lingüístico. No usar como módulo principal para diseñar autonomía, herramientas o workflows de agentes.
...
Para controles generales de secretos, privacidad, toxicidad y uso indebido, carga `../seguridad/seguridad_modelos_ia_reglas.md`.
