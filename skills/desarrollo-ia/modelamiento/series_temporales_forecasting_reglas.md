...
El tiempo, el horizonte o la disponibilidad futura de variables determina el diseño y la evaluación. No usar como módulo principal si el orden temporal no afecta la tarea.
