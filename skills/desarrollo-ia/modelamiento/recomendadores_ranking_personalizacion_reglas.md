...
La salida ordena, filtra o personaliza ítems para usuarios o contextos. No usar como módulo principal para clasificación genérica sin componente de ranking o recomendación.
