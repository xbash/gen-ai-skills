...
Las entidades y relaciones son la estructura central del problema. No usar como módulo principal si el grafo solo es una representación auxiliar sin efecto en datos, modelo o evaluación.
