...
Aplicar cuando la tarea requiera ingesta, preparación, validación, feature engineering, entrenamiento, evaluación, benchmarking, comparación de modelos o reporte técnico de resultados.

## Usar cuando

La tarea prepara datos, define features, compara resultados o necesita reproducibilidad. No cargarlo automáticamente para una consulta conceptual, de serving o de seguridad aislada.
