...
La tarea define o ejecuta pruebas, criterios de aceptación, evaluación comparativa o regresión de modelos, prompts o sistemas. No usar como sustituto del módulo especializado que define el contenido técnico evaluado.
...
Este módulo define el protocolo de pruebas y aceptación. Las reglas de datos, features o reproducibilidad experimental pertenecen a `datos_experimentos_reglas.md`; las amenazas de seguridad pertenecen a `../seguridad/seguridad_modelos_ia_reglas.md`.
