...
| `analisis_notebook_matematicas.md` | Revision de notebooks de matematicas, algebra, calculo, optimizacion y metodos numericos. |
| `analisis_notebook_ciberseguridad.md` | Revision de notebooks de ciberseguridad defensiva, logs, hardening, AppSec y deteccion. |
| `checklist_revision_notebook.md` | Checklist transversal para revisar cualquier notebook antes de completar o entregar. |
