# Checklist — Seguridad de producto y aplicación

Usar antes de entregar análisis, scripts, reportes, revisiones de código, planes de remediación o recomendaciones AppSec.
