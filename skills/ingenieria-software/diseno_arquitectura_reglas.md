...
USAR CUANDO: la tarea requiera decidir estructura, responsabilidades, contratos, algoritmos o trade-offs.

NO USAR CUANDO: solo se necesita una correccion local sin impacto de diseno.
