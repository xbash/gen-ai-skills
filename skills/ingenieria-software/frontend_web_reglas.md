...
USAR CUANDO: se disenen o modifiquen interfaces web, componentes, formularios, estado o accesibilidad.

NO USAR CUANDO: la tarea no tenga interfaz de usuario ni comportamiento de cliente.
