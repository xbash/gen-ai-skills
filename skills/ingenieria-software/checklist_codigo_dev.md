...
USAR CUANDO: se prepare una entrega, una revision final o una correccion con criterios verificables.

NO USAR CUANDO: se encuentre en una exploracion inicial sin cambio ni resultado que validar.
