...
USAR CUANDO: se trabajen esquemas, consultas, SQL, ORM, transacciones, migraciones o persistencia.

NO USAR CUANDO: la tarea no lea, escriba ni modifique datos persistentes.
