...
USAR CUANDO: se implementen o revisen servicios server-side, APIs, workers, colas o integraciones.

NO USAR CUANDO: el cambio sea exclusivamente de interfaz visual o de persistencia sin logica de servicio.
