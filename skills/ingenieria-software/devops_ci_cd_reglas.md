...
USAR CUANDO: se construyan, empaqueten, publiquen, desplieguen u operen artefactos de software.

NO USAR CUANDO: el cambio sea exclusivamente de logica de negocio sin impacto en entrega u operacion.
