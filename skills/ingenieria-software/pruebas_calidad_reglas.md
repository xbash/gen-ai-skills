...
USAR CUANDO: se corrija, refactorice, pruebe o entregue software con riesgo de regresion.

NO USAR CUANDO: solo se este describiendo una idea sin codigo ni comportamiento verificable.
