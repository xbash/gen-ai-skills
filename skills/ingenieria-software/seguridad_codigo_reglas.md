...
USAR CUANDO: exista superficie de ataque, datos sensibles, autenticacion, secretos, dependencias o una revision defensiva.

NO USAR CUANDO: la tarea sea puramente editorial y no cambie codigo, configuracion ni datos.
