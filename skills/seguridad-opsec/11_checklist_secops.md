# Checklist — Seguridad organizacional y operacional

Usar antes de entregar análisis, scripts, playbooks, planes, reportes o recomendaciones de seguridad operacional.
