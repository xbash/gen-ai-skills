...
Objetivo:
determinar mecánicamente el estado real del dominio `lenguaje-castellano`.
...
No refactorices.
No modifiques archivos dentro de skills/lenguaje-castellano/.
No avances automáticamente a fases posteriores.

Inspecciona:

- existencia y accesibilidad de skills/lenguaje-castellano/;
